...
This sums up the objects during the execution of a game. Some objects such as the deserializers and the UI have been abstracted away as they do not hold variables and states. 
