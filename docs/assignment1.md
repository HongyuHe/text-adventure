...
|---|---|---|
| F1  | Commands  | The player can control the main character by issuing command-line commands following this syntax: `command + [target]`, where (\*) indicates a noun is optional. Available `commands` are: <br/> - `move` + [north, east, south, west, area-name] <br/> - `use` + [item] <br/> - `look` + [item]\* <br/> - `interact` + [npc, item] <br/> - `inventory` <br/> - `save` <br/> - `load` <br/> - `quit` <br/> |
